...
from src.core.environments.engine_env import reward_fn, EngineEnvDiscrete, EngineEnvContinuous

from src.utils.utils import ActionAdapter, TimingRecorder
...
from src.core.safety.safety_filter import SafetyFilter
...
class Minion:
    ...
    def collect_rollouts(
        ...
        for i in range(n_rollouts):
            ...
            # Collect filter training data: (current_state, action_filtered, next_state, action_nominal)
